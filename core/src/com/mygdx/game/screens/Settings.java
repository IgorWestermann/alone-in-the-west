...
public class Settings implements Screen {
    ...
    public void show() {
        ...
        this.coffinHealth = addSliderInput("Vida do Caixão", 1, 20, 20, 0);

        this.playerDamage = addSliderInput("Dano do Jogador ", 1, 20, 20, 0);
        this.cactusDamage = addSliderInput("Dano do Cactu", 1, 20, 20, 0);
        this.coffinDamage = addSliderInput("Dano do Caixão", 1, 20, 20, 0);
        ...
        this.coffinSpeed = addSliderInput("Velocidade do Caixão", 1, 120, 20, 0);
